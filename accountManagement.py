...
from locators import LoginPageLocators,HomePageLocators,AccountManagement
...
def selenium(driver,login_url):
    ...
    username_input.send_keys("jeetu@gmail.com")
    ...
    login_button.click()
    driver.find_element(By.XPATH,"//*[@id='root']/div/div[1]/div/div[4]/a").click()
    time.sleep(2)
    driver.find_element(By.XPATH,AccountManagement.NAME).send_keys("Testname")
    driver.find_element(By.XPATH,AccountManagement.MOBILE_NUMBER).send_keys("9999999999")
    driver.find_element(By.XPATH,AccountManagement.AlTERNATE_NUMBER).send_keys("888888888")
